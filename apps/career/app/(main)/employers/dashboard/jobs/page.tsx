import { MOCK_JOBS } from "@/lib/data/mock-dashboard";
import { Search, MoreHorizontal, FileEdit, Trash2, PauseCircle } from "lucide-react";
              ...
              {MOCK_JOBS.map((job) => (
                <tr key={job.id} className="hover:bg-[var(--surface-2)]/50 transition-colors">
                  <td className="px-6 py-4">
                    ...
                    <p className="text-xs text-[var(--muted-fg)] mt-1">{job.type}</p>
                  </td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button className="p-1.5 text-[var(--muted-fg)] hover:text-[var(--primary)] hover:bg-[var(--primary)]/10 rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)]" aria-label="Edit">
                        <FileEdit size={16} />
                      </button>
                      <button className="p-1.5 text-[var(--muted-fg)] hover:text-yellow-600 hover:bg-yellow-50 rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-500" aria-label="Pause">
                        <PauseCircle size={16} />
                      </button>
                      <button className="p-1.5 text-[var(--muted-fg)] hover:text-red-600 hover:bg-red-50 rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500" aria-label="Delete">
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </td>
