...
export function AnimatedBackground() {
  ...
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none bg-background">
      ...
      <motion.div style={{ y: y1 }} className="absolute top-[-10%] left-[-15%] w-[60vw] h-[60vw] opacity-30">
        <motion.div
      ...
      <motion.div style={{ y: y3 }} className="absolute bottom-[-20%] left-[20%] w-[70vw] h-[70vw] opacity-20">
        <motion.div
