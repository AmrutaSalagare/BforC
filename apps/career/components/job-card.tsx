...
export function JobCard({ job }: { job: Job }) {
  ...
  return (
    <motion.article
      ...
      className="relative bg-white/40 backdrop-blur-md rounded-xl p-6 pb-16 border border-white/60 hover:border-[var(--accent-color)]/30 cursor-pointer group shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition duration-300"
