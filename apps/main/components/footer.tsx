...
export function Footer() {
  ...
  return (
    <footer className="bg-[#24201e] text-[#eeebe7] pt-20 pb-10 px-8 relative z-10 border-t border-[#36312e]">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div className="flex flex-col gap-6 md:col-span-1">
          <Link href="/" className="flex items-center gap-2 group">
            <div className="relative h-8 w-28 flex items-center">
              <Image
                ...
                className="object-contain filter invert brightness-200 contrast-120"
              />
            </div>
          </Link>
          <p className="text-xs text-[#c4beba] leading-relaxed max-w-xs font-light">
          ...
          <div className="flex gap-4 mt-2">
            <a
              href="#"
              className="text-[#c4beba] hover:text-[var(--primary)] transition-colors duration-300"
              aria-label="LinkedIn"
            >
        ...
        <div className="flex flex-col gap-4">
          <span className="text-[10px] font-semibold tracking-widest uppercase text-[#9e9590] font-mono-dm">
            Navigation
          </span>
          <ul className="flex flex-col gap-2.5 text-sm text-[#c4beba]">
            ...
            <li>
              <Link href="/#benefits" className="hover:text-white transition-colors duration-200">
                Member benefits
              </Link>
            </li>
            <li>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 text-sm text-[#c4beba]">
            <a
            ...
            <a
              ...
              className="flex items-center gap-2 hover:text-white transition-colors duration-200 text-xs"
            >
              <span className="text-[var(--primary)] font-semibold shrink-0">+91</span>
              <span>9461992263</span>
            </a>
            <div className="flex items-start gap-2 pt-2 border-t border-[#36312e]">
              <MapPin size={14} className="text-[var(--primary)] shrink-0 mt-0.5" />
              <span className="leading-relaxed text-[11px] text-[#c4beba]">
      ...
      {/* Bottom Bar */}
      <div className="max-w-5xl mx-auto pt-8 border-t border-[#36312e] flex flex-col md:flex-row items-center justify-between gap-4 text-[10px] text-[#9e9590] font-mono-dm">
        <div>
        ...
        <div className="flex flex-wrap gap-x-6 gap-y-2 justify-center">
          ...
          <Link href="/data-protection" className="hover:text-white transition-colors duration-200">
            Data Protection
          </Link>
          <Link href="/anti-harassment" className="hover:text-white transition-colors duration-200">
